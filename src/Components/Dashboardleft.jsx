 ...
 *
 * Represents the left section of the dashboard UI.
 * Contains:
 * - A top search bar
 * - Dashboard heading and filter dropdown
 * - Anatomy/3D body component
 * - List of health progress cards
 * - User activity chart
 *
 * Props: None
 * Data Source:
 * - `healthData`: Array of health stats for dynamic card rendering
 * - `activityData`: Chart data passed to Activity component
 */
    ...
    return (
      <div className="w-full md:w-[90%] lg:w-[80%] mb-2 mt-3 xl:w-[55%] px-4">
        ...
        <div className="w-full md:flex justify-between items-start p-5 gap-6">
              {/*  human body visualization section */}
          <AnatomySection />
